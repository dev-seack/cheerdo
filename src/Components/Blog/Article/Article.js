      ...
      <div className="maxContainer">
        ...
        <Aux isContentContainer>
          <p className="ArticleText">
            ...
            regelmaessig an Wettkaempfen, Vorstellungen, extern sowie Intern
            teil. Ausserdem teilen wir gerne Trainingseinheiten, Wettkaempfe,
            Veranstalltungen und viele weitere spannende Dinge rund um und ueber
            den United Cheer Sports Verein in Dortmund.Wir nehmen regelmaessig
            an Wettkaempfen, Vorstellungen, extern sowie Intern teil. Ausserdem
            teilen wir gerne Trainingseinheiten, Wettkaempfe, Veranstalltungen
            und viele weitere spannende Dinge rund um und ueber den United Cheer
          ...
          <div className="ArticleNewsInnerContainer">
            <Link
              to={"/article/" + articlesID}
              className="NewsPreviewContainer"
            >
              <NewsPreview
